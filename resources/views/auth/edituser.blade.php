            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!-- <form class="form-horizontal" method="POST" action="{{ action('DashboardController@updateUser') }}"> -->
                      {!! Form::open(['class' => 'form-horizontal','action' => 'DashboardController@updateUser', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                      <div class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                          <label for="avatar" class="col-md-4 control-label">Avatar</label>

                          <div class="col-md-6">
                              <!-- <input id="avatar" type="text" class="form-control" name="avatar" value="{{ Auth::user()->avatar }}" required autofocus> -->
                              <img class="avatar-image" style="width:100%" src="{{ Auth::user()->avatar }}">
                              <br><br>
                              <!-- <span class="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span> -->
                              <!-- <a href='{!! url('/edituser'); !!}'><b>Upload Image</b></a> -->
                              {{Form::file('avatar',  ['id' => 'avatar-upload','multiple'=>false])}}
